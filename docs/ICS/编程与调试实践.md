...
2. 实验文档
   ![bomblab](../files/ICS/bomblab.pdf){ type=application/pdf style="width:100%; min-height:70vh;" }
...
2. 实验文档
   ![buflab](../files/ICS/buflab.pdf){ type=application/pdf style="width:100%; min-height:70vh;" }
