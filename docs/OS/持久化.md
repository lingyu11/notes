...
4. 控制设备 - ioctl (用于设备控制的系统调用)：“非数据” 的设备功能几乎全部依赖 ioctl，“Arguments, returns, and semantics of ioctl() vary according to the device driver in question”
